...
var Main = {
    ...
    methods: {
        greet: function (xx) {
            ...
            // if (y3<(w1-w)){
            //     y3=w1-w;
            //     x3=-(y3*(x1*x2*y4*z5 - x1*x2*y5*z4 - x1*x4*y2*z5 + x1*x4*y5*z2 + x2*x5*y1*z4 - x2*x5*y4*z1 - x4*x5*y1*z2 + x4*x5*y2*z1))/(x1*y2*y5*z4 - x1*y4*y5*z2 - x2*y1*y4*z5 + x2*y4*y5*z1 + x4*y1*y2*z5 - x4*y2*y5*z1 - x5*y1*y2*z4 + x5*y1*y4*z2);
            //     z3=(y3*(x1*y2*z4*z5 - x1*y4*z2*z5 - x2*y1*z4*z5 + x2*y5*z1*z4 + x4*y1*z2*z5 - x4*y5*z1*z2 - x5*y2*z1*z4 + x5*y4*z1*z2))/(x1*y2*y5*z4 - x1*y4*y5*z2 - x2*y1*y4*z5 + x2*y4*y5*z1 + x4*y1*y2*z5 - x4*y2*y5*z1 - x5*y1*y2*z4 + x5*y1*y4*z2);
            //
            //     y4=-(w-w1);
            //     z4=-h;
            //     x4=(y4*(x1*z3 - x3*z1))/(y1*z3 - y3*z1) - (z4*(x1*y3 - x3*y1))/(y1*z3 - y3*z1)
            // }
