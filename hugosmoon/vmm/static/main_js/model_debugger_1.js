...
let Main = {
    ...
    methods: {
        ...
        add_model: function () {
            ...
            if(this.model_name!=''){
                index+=1;
                models_info[index]=new Model(view_name,this.model_name,this.model_url,index);
            ...
            this.$http.post(
                ...
                { emulateJSON: true }
                    ...
                    models_got.forEach(model => {
                        ...
                        models_info[index]=new Model(model.view_name,model.model_name,model.model_url,index);
...
//模型对象
function Model(view_name,name,url,index){
